...
export default function NotesPage() {
  ...
  // Filter notes di client secara responsif
    ...
    <div className="max-w-6xl mx-auto px-4 sm:px-6 py-8 space-y-6">
      ...
      {isLoading ? (
        <div className="flex flex-col items-center justify-center min-h-[30vh] text-stone-400">
          <RotateCw className="w-7 h-7 animate-spin text-orange-500 mb-2" />
          <p className="text-xs">Memuat koleksi catatan...</p>
        </div>
